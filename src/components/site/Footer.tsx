    ...
    <footer className="bg-primary text-primary-foreground">
      <div className="mx-auto max-w-7xl px-5 py-20 md:px-8 md:py-24">
        <div className="grid gap-14 lg:grid-cols-12">
          ...
          <div className="grid gap-10 sm:grid-cols-3 lg:col-span-7">
            <div>
              ...
              <h3 className="mt-4 text-base text-primary-foreground">{t.footer.address}</h3>
              <a
                href={MAPS}
                target="_blank"
                rel="noopener noreferrer"
            ...
            <div>
              ...
              <h3 className="mt-4 text-base text-primary-foreground">{t.footer.phone}</h3>
              <a
                href={`tel:${PHONE_TEL}`}
            ...
            <div>
              ...
              <h3 className="mt-4 text-base text-primary-foreground">{t.footer.hours}</h3>
        ...
        <div className="mt-12 flex flex-col items-start justify-between gap-4 border-t border-primary-foreground/15 pt-6 text-xs text-primary-foreground/55 sm:flex-row sm:items-center">
          <span>
            © {new Date().getFullYear()} Herbolario Spa La Tejita. {t.footer.rights}
          </span>
          <span className="uppercase tracking-[0.18em]">{t.footer.region}</span>
        </div>
      </div>
    </footer>
  );
